...
try:
    prox= requests.get('https://github.com/Jok4rsoj1b4/PAID-404/blob/main/Aprov.txt').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/Jok4rsoj1b4/PAID-404/blob/main/Aprov.txt').text.splitlines()
    for line in xx:
